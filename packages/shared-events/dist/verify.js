...
async function verifyEvents() {
    ...
    try {
        ...
        if (channels_1.REDIS_CHANNELS.APPOINTMENT_SCHEDULED === 'appointment.scheduled') {
            console.log('✅ TEST 1: Canales de Redis mapeados correctamente.');
        }
        // TEST 2: Serialización de Eventos (Lógica)
        const bus = new event_bus_1.EventBus({ lazyConnect: true }); // No intenta conectar inmediatamente
        ...
        const channel = channels_1.REDIS_CHANNELS.METRICS_EVENT;
        if (channel) {
