...
function test1() {
    ...
    const encrypted = (0, index_1.encryptAES256)(text, secret);
    const decrypted = (0, index_1.decryptAES256)(encrypted, secret);
    if (text === decrypted) {
...
function test2() {
    ...
    const ok = (0, index_1.isWithinSchedule)(monday10AM, '09:00', '18:00', timezone);
    const tooLate = (0, index_1.isWithinSchedule)(monday10AM, '12:00', '18:00', timezone);
    if (ok && !tooLate) {
 ...
 */
function test3() {
    const slots = (0, index_1.calculateSlots)('09:00', '11:00', 30);
...
function test4() {
    ...
    const token = (0, index_1.signJWT)({ user: 'test' }, secret, '0s');
    try {
        // Esperamos un pequeño delay para asegurar la expiración
        (0, index_1.verifyJWT)(token, secret);
...
function test5() {
    ...
    const encrypted = (0, index_1.encryptAES256)(text, secret);
    try {
        (0, index_1.decryptAES256)(encrypted, wrongSecret);
